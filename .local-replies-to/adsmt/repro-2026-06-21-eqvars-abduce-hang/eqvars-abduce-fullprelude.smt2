...
(declare-fun ens%abduct_eq_vars!p. (Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int)) (!
   (= (ens%abduct_eq_vars!p. x! y!) (= (Sub x! y!) 0))
   :pattern ((ens%abduct_eq_vars!p. x! y!))
   :qid internal_ens__abduct_eq_vars!p._definition
)))
(push)
(declare-const x! Int)
(declare-const y! Int)
...
(declare-abducible (< y! 0))
(declare-abducible (= y! 0))
(declare-abducible (not (= y! 0)))
(declare-abducible (> x! y!))
(declare-abducible (>= x! y!))
(declare-abducible (= x! y!))
(declare-abducible (not (= x! y!)))
(declare-abducible (> y! x!))
(declare-abducible (>= y! x!))
(abduce (= (Sub x! y!) 0))
