...
(assert
 (forall ((x! Int)) (!
   (= (ens%hc2!lem. x!) (> x! 5))
   :pattern ((ens%hc2!lem. x!))
   :qid internal_ens__hc2!lem._definition
)))
(push)
(declare-const x! Int)
(assert
...
(pop)
(pop)
(declare-fun ens%hc2!p. (Int) Bool)
(assert
 (forall ((x! Int)) (!
   (= (ens%hc2!p. x!) (> x! 5))
   :pattern ((ens%hc2!p. x!))
   :qid internal_ens__hc2!p._definition
)))
(push)
(declare-const x! Int)
(assert
...
(declare-abducible (<= x! 5))
(declare-abducible (>= x! 5))
(declare-abducible (<= x! (- 5)))
(declare-abducible (>= x! (- 5)))
(declare-abducible (ens%hc2!lem. x!))
(abduce (> x! 5))
