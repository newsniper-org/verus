...
#[allow(dead_code)]
// Tracks the Honey-Be/oxiz fork (branch `0.2.4-redesign`,
// submodule pin per Y4 unified-toolkit-pin.toml). Bare version
// string from oxiz/Cargo.toml workspace package. Bumped to 0.2.4
// with adsmt rc.36: the abduct-theory delegation rides the
// vendored-OxiZ soundness fix (UF-of-int sort persistence +
// pattern-guided MBQI) + CDQI on this branch.
pub const EXPECTED_OXIZ_VERSION: &str = "0.2.4";
#[allow(dead_code)]
...
pub const EXPECTED_ADSMT_VERSION: &str = "1.0.0-rc.42.1";
