...
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!function.axiom_fn_mut_call_requires.) 0)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!function.axiom_fn_mut_call_ensures.) 1)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!array.group_array_axioms.) 2)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!function.group_function_axioms.) 3)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!imap.group_imap_lemmas.) 4)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!iset.group_iset_lemmas.) 5)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_cmp.group_laws_cmp.) 6)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.bool_laws.group_laws_eq.) 7)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.u8_laws.group_laws_eq.) 8)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.i8_laws.group_laws_eq.) 9)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.u16_laws.group_laws_eq.) 10)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.i16_laws.group_laws_eq.) 11)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.u32_laws.group_laws_eq.) 12)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.i32_laws.group_laws_eq.) 13)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.u64_laws.group_laws_eq.) 14)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.i64_laws.group_laws_eq.) 15)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.u128_laws.group_laws_eq.) 16)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.i128_laws.group_laws_eq.) 17)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.usize_laws.group_laws_eq.) 18)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.isize_laws.group_laws_eq.) 19)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.tuple_1_laws.group_laws_eq.) 20)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.tuple_2_laws.group_laws_eq.) 21)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.tuple_3_laws.group_laws_eq.) 22)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.tuple_4_laws.group_laws_eq.) 23)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.tuple_5_laws.group_laws_eq.) 24)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.tuple_6_laws.group_laws_eq.) 25)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.tuple_7_laws.group_laws_eq.) 26)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.tuple_8_laws.group_laws_eq.) 27)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.tuple_9_laws.group_laws_eq.) 28)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.tuple_10_laws.group_laws_eq.) 29)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.tuple_11_laws.group_laws_eq.) 30)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.tuple_12_laws.group_laws_eq.) 31)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!laws_eq.group_laws_eq.) 32)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!layout.group_align_properties.) 33)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!layout.group_layout_axioms.) 34)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!map.group_map_lemmas.) 35)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!multiset.group_multiset_axioms.) 36)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!raw_ptr.group_raw_ptr_axioms.) 37)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!seq.group_seq_axioms.) 38)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!seq_lib.group_filter_ensures.) 39)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!seq_lib.group_seq_lib_default.) 40)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!set.group_set_lemmas.) 41)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!set_lib.group_set_lib_default.) 42)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!slice.group_slice_axioms.) 43)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!string.group_string_axioms.) 44)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!std_specs.bits.group_bits_axioms.) 45)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!std_specs.control_flow.group_control_flow_axioms.)
  46
))
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!std_specs.iter.group_iter_axioms.) 47)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!std_specs.manually_drop.group_manually_drop_axioms.)
  48
))
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!std_specs.btree.group_btree_axioms.) 49)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!std_specs.hash.group_hash_axioms.) 50)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!std_specs.range.group_range_axioms.) 51)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!std_specs.slice.group_slice_axioms.) 52)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!std_specs.vec.group_vec_axioms.) 53)
)
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!std_specs.vecdeque.group_vec_dequeue_axioms.)
  54
))
(assert
 (= (%%fuel_distinct_ord%% fuel%vstd!group_vstd_default.) 55)
)
(assert
 (=>
...
(assert
 (=>
  ...
  (forall ((Args&. Dcr) (Args& Type) (F&. Dcr) (F& Type) (f! Poly) (args! Poly) (output!
    ...
    :qid user_vstd__function__axiom_fn_mut_call_ensures_1
))))
...
;; Function-Specs abduct_eq_zero::p
(declare-fun ens%abduct_eq_zero!p. (Int) Bool)
(assert
 (forall ((x! Int)) (!
   (= (ens%abduct_eq_zero!p. x!) (= x! 0))
   :pattern ((ens%abduct_eq_zero!p. x!))
   :qid internal_ens__abduct_eq_zero!p._definition
)))

;; Function-Def abduct_eq_zero::p
;; scripts/a2-fixtures/abduct-eq-zero.rs:2:15: 2:27 (#0)
(push)
 (declare-const x! Int)
 (assert
  fuel_defaults
 ...
 (abduce (= x! 0))
 (set-option :abduct-theory false)
(pop)

;; Function-Recommends abduct_eq_zero::p
;; scripts/a2-fixtures/abduct-eq-zero.rs:2:15: 2:27 (#0)
(push)
 (declare-const x! Int)
 (assert
